      ...
      <div className="w-full h-full flex flex-col items-center justify-center bg-white p-8 sm:p-12 md:p-16">
        <div className="w-full max-w-sm space-y-6 animate-fadeIn">
          ...
          <div className="text-center md:text-left flex flex-col items-center md:items-start justify-center">
            ...
            <h1 className="font-serif text-2xl font-bold tracking-wide text-tdc-dark">
              The Date Crew
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-2">
            ...
            <button
              type="submit"
              className="w-full bg-tdc-green hover:bg-tdc-green-hover text-white text-xs font-semibold py-3 rounded-xl transition-all shadow-xs tracking-wide cursor-pointer mt-2"
            >
